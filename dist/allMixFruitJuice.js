...
// module
exports.push([module.i, ".firstBlock {\n  background: lightgray;\n  padding: 10px;\n  margin-top: 5px;\n  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; }\n\n.header {\n  font-size: 1.6em;\n  padding: 20px;\n  margin: 10px;\n  background: lightblue;\n  text-align: center; }\n", ""]);
...
var FunctionalComponent = function FunctionalComponent(_ref) {
  var name = _ref.name,
      job = _ref.job,
      introStatus = _ref.introStatus;
  console.log(name, job, introStatus);
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    class: "firstBlock"
  }, "I'm a functional component. I just take props and return a value. Rest assured that you'll get the same response given you pass me the same props! In this case, I took name, job and introStatus as props. I currently received introStatus as ", ". So, stating the obvious, ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("strong", null, name, " is a ", job, " :P"), "\"");
};
...
/* harmony import */ var _components_FunctionalComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/FunctionalComponent */ "./src/components/FunctionalComponent.jsx");
...
function (_Component) {
  ...
  function MyApp(props) {
    ...
    _this.getIntroStatus = _this.getIntroStatus.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(MyApp, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        class: "header"
      }, " Welcome to MyApp! "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_FunctionalComponent__WEBPACK_IMPORTED_MODULE_2__["FunctionalComponent"], {
        name: 'Pushkar',
        job: 'Software Engineer',
        introStatus: this.introComplete
      }), "Back to the main component, now the introStatus is: ", this.introComplete, ". This only depicts how I set the state with new value once introduction was done.");
    }
  }, {
    key: "getIntroStatus",
    value: function getIntroStatus() {
      this.setState({
        introComplete: "true"
      });
    }
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(MyApp, null), document.getElementById('root'));
